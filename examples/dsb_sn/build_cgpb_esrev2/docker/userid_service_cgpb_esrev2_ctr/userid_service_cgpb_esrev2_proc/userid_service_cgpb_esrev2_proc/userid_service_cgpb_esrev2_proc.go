...
func New_userid_service_cgpb_esrev2_proc(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_userid_service_cgpb_esrev2_proc_Args(b)
	set_userid_service_cgpb_esrev2_proc_Instances(b)
	set_userid_service_cgpb_esrev2_proc_Definitions(b)
	return b
}
...
func set_userid_service_cgpb_esrev2_proc_Args(b *golang.NamespaceBuilder) {
	...
	b.Required("userid_service_cgpb_esrev2.grpc.bind_addr", "Argument generated by Blueprint IR: userid_service_cgpb_esrev2.grpc.bind_addr = AddressConfig()")
}
...
func set_userid_service_cgpb_esrev2_proc_Instances(b *golang.NamespaceBuilder) {
	...
	b.Instantiate("userid_service_cgpb_esrev2")
	b.Instantiate("otelcol_cgpb_esrev2.client")
	b.Instantiate("userid_service_cgpb_esrev2.server.ot")
	b.Instantiate("userid_service_cgpb_esrev2.grpc_server")
}
