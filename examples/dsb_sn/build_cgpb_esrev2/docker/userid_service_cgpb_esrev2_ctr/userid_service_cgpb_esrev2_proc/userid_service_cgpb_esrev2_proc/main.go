// userid_service_cgpb_esrev2_proc runs the userid_service_cgpb_esrev2_proc Golang process.
//
// userid_service_cgpb_esrev2_proc is auto-generated by Blueprint's goproc plugin (goproc/goprocgen/main.go.go)
//
// Usage:
//
//	go run main.go --user_cache_cgpb_esrev2.dial_addr=value --user_db_cgpb_esrev2.dial_addr=value --otelcol_cgpb_esrev2.dial_addr=value --userid_service_cgpb_esrev2.grpc.bind_addr=value
//
...
//
// userid_service_cgpb_esrev2_proc requires the following arguments are passed:
//
...
//	    Auto-generated by Blueprint IR node:
//	    userid_service_cgpb_esrev2.grpc.bind_addr = AddressConfig()
//
// userid_service_cgpb_esrev2_proc will instantiate the following IR nodes:
//
...
func main() {
	...
	slog.Info("Running userid_service_cgpb_esrev2_proc")
	n, err := New_userid_service_cgpb_esrev2_proc("userid_service_cgpb_esrev2_proc").Build(context.Background())
	if err != nil {
		slog.Error(err.Error())
		os.Exit(1)
	}
	n.Await()
	slog.Info("userid_service_cgpb_esrev2_proc exiting")
}
