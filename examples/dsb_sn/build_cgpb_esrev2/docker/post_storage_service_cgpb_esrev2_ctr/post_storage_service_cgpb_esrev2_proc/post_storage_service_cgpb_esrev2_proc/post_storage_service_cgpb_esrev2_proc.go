...
func New_post_storage_service_cgpb_esrev2_proc(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_post_storage_service_cgpb_esrev2_proc_Args(b)
	set_post_storage_service_cgpb_esrev2_proc_Instances(b)
	set_post_storage_service_cgpb_esrev2_proc_Definitions(b)
	return b
}
...
func set_post_storage_service_cgpb_esrev2_proc_Args(b *golang.NamespaceBuilder) {
	b.Required("otelcol_cgpb_esrev2.dial_addr", "Argument generated by Blueprint IR: otelcol_cgpb_esrev2.dial_addr = AddressConfig()")
	b.Required("post_cache_cgpb_esrev2.dial_addr", "Argument generated by Blueprint IR: post_cache_cgpb_esrev2.dial_addr = AddressConfig()")
	b.Required("post_db_cgpb_esrev2.dial_addr", "Argument generated by Blueprint IR: post_db_cgpb_esrev2.dial_addr = AddressConfig()")
	b.Required("post_storage_service_cgpb_esrev2.grpc.bind_addr", "Argument generated by Blueprint IR: post_storage_service_cgpb_esrev2.grpc.bind_addr = AddressConfig()")
}
...
func set_post_storage_service_cgpb_esrev2_proc_Instances(b *golang.NamespaceBuilder) {
	...
	b.Instantiate("post_cache_cgpb_esrev2.client")
	b.Instantiate("post_db_cgpb_esrev2.client")
	b.Instantiate("post_storage_service_cgpb_esrev2")
	b.Instantiate("otelcol_cgpb_esrev2.client")
	b.Instantiate("post_storage_service_cgpb_esrev2.server.ot")
	b.Instantiate("post_storage_service_cgpb_esrev2.grpc_server")
}
