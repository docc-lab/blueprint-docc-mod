...
func New_text_service_cgpb_esrev2_proc(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_text_service_cgpb_esrev2_proc_Args(b)
	set_text_service_cgpb_esrev2_proc_Instances(b)
	set_text_service_cgpb_esrev2_proc_Definitions(b)
	return b
}
...
func set_text_service_cgpb_esrev2_proc_Args(b *golang.NamespaceBuilder) {
	b.Required("otelcol_cgpb_esrev2.dial_addr", "Argument generated by Blueprint IR: otelcol_cgpb_esrev2.dial_addr = AddressConfig()")
	b.Required("text_service_cgpb_esrev2.grpc.bind_addr", "Argument generated by Blueprint IR: text_service_cgpb_esrev2.grpc.bind_addr = AddressConfig()")
	b.Required("urlshorten_service_cgpb_esrev2.grpc.dial_addr", "Argument generated by Blueprint IR: urlshorten_service_cgpb_esrev2.grpc.dial_addr = AddressConfig()")
	b.Required("usermention_service_cgpb_esrev2.grpc.dial_addr", "Argument generated by Blueprint IR: usermention_service_cgpb_esrev2.grpc.dial_addr = AddressConfig()")
}
...
func set_text_service_cgpb_esrev2_proc_Instances(b *golang.NamespaceBuilder) {
	...
	b.Instantiate("urlshorten_service_cgpb_esrev2.grpc_client")
	b.Instantiate("otelcol_cgpb_esrev2.client")
	b.Instantiate("urlshorten_service_cgpb_esrev2.client.ot")
	b.Instantiate("urlshorten_service_cgpb_esrev2.client.retrier")
	b.Instantiate("urlshorten_service_cgpb_esrev2.client")
	b.Instantiate("usermention_service_cgpb_esrev2.grpc_client")
	b.Instantiate("usermention_service_cgpb_esrev2.client.ot")
	b.Instantiate("usermention_service_cgpb_esrev2.client.retrier")
	b.Instantiate("usermention_service_cgpb_esrev2.client")
	b.Instantiate("text_service_cgpb_esrev2")
	b.Instantiate("text_service_cgpb_esrev2.server.ot")
	b.Instantiate("text_service_cgpb_esrev2.grpc_server")
}
