// text_service_cgpb_esrev2_proc runs the text_service_cgpb_esrev2_proc Golang process.
//
// text_service_cgpb_esrev2_proc is auto-generated by Blueprint's goproc plugin (goproc/goprocgen/main.go.go)
//
// Usage:
//
//	go run main.go --urlshorten_service_cgpb_esrev2.grpc.dial_addr=value --otelcol_cgpb_esrev2.dial_addr=value --usermention_service_cgpb_esrev2.grpc.dial_addr=value --text_service_cgpb_esrev2.grpc.bind_addr=value
//
...
//
// text_service_cgpb_esrev2_proc requires the following arguments are passed:
//
//	--urlshorten_service_cgpb_esrev2.grpc.dial_addr
//	    Auto-generated by Blueprint IR node:
//	    urlshorten_service_cgpb_esrev2.grpc.dial_addr = AddressConfig()
//
...
//	    Auto-generated by Blueprint IR node:
//	    usermention_service_cgpb_esrev2.grpc.dial_addr = AddressConfig()
//
//	--text_service_cgpb_esrev2.grpc.bind_addr
//	    Auto-generated by Blueprint IR node:
//	    text_service_cgpb_esrev2.grpc.bind_addr = AddressConfig()
//
// text_service_cgpb_esrev2_proc will instantiate the following IR nodes:
//
...
func main() {
	...
	slog.Info("Running text_service_cgpb_esrev2_proc")
	n, err := New_text_service_cgpb_esrev2_proc("text_service_cgpb_esrev2_proc").Build(context.Background())
	if err != nil {
		slog.Error(err.Error())
		os.Exit(1)
	}
	n.Await()
	slog.Info("text_service_cgpb_esrev2_proc exiting")
}
