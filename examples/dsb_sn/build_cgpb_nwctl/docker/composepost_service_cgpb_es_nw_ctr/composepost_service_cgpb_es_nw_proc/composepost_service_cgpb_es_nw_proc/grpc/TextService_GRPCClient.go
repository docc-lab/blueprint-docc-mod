...
func (client *TextService_GRPCClient) ComposeText(ctx context.Context, reqID int64, text string, traceCtx string) (ret0 string, ret1 []snnw.UserMention, ret2 []snnw.URL, err error) {
