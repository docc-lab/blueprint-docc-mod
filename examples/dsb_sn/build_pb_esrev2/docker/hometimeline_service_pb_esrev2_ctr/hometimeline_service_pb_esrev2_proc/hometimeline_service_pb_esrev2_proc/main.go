// hometimeline_service_pb_esrev2_proc runs the hometimeline_service_pb_esrev2_proc Golang process.
//
// hometimeline_service_pb_esrev2_proc is auto-generated by Blueprint's goproc plugin (goproc/goprocgen/main.go.go)
//
// Usage:
//
//   go run main.go --hometimeline_cache_pb_esrev2.dial_addr=value --post_storage_service_pb_esrev2.grpc.dial_addr=value --otelcol_pb_esrev2.dial_addr=value --socialgraph_service_pb_esrev2.grpc.dial_addr=value --hometimeline_service_pb_esrev2.grpc.bind_addr=value 
//
...
//
// hometimeline_service_pb_esrev2_proc requires the following arguments are passed:
//
//   --hometimeline_cache_pb_esrev2.dial_addr
//       Auto-generated by Blueprint IR node:
//       hometimeline_cache_pb_esrev2.dial_addr = AddressConfig()
//
...
//       Auto-generated by Blueprint IR node:
//       hometimeline_service_pb_esrev2.grpc.bind_addr = AddressConfig()
//
// hometimeline_service_pb_esrev2_proc will instantiate the following IR nodes:
...
func main() {
	...
	slog.Info("Running hometimeline_service_pb_esrev2_proc")
	n, err := New_hometimeline_service_pb_esrev2_proc("hometimeline_service_pb_esrev2_proc").Build(context.Background())
	if err != nil {
		slog.Error(err.Error())
		os.Exit(1)
	}
	n.Await()
	slog.Info("hometimeline_service_pb_esrev2_proc exiting")
}