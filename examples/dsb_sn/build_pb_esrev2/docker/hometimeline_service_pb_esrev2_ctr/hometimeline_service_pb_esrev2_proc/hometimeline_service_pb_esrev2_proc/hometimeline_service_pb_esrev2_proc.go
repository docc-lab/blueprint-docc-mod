...
func New_hometimeline_service_pb_esrev2_proc(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_hometimeline_service_pb_esrev2_proc_Args(b)
	set_hometimeline_service_pb_esrev2_proc_Instances(b)
	set_hometimeline_service_pb_esrev2_proc_Definitions(b)
	return b
}
...
func set_hometimeline_service_pb_esrev2_proc_Args(b *golang.NamespaceBuilder) {
	b.Required("hometimeline_cache_pb_esrev2.dial_addr", "Argument generated by Blueprint IR: hometimeline_cache_pb_esrev2.dial_addr = AddressConfig()")
	b.Required("hometimeline_service_pb_esrev2.grpc.bind_addr", "Argument generated by Blueprint IR: hometimeline_service_pb_esrev2.grpc.bind_addr = AddressConfig()")
...
func set_hometimeline_service_pb_esrev2_proc_Instances(b *golang.NamespaceBuilder) {
	...
	b.Instantiate("hometimeline_cache_pb_esrev2.client")
	...
	b.Instantiate("hometimeline_service_pb_esrev2")
	b.Instantiate("hometimeline_service_pb_esrev2.server.ot")
	b.Instantiate("hometimeline_service_pb_esrev2.grpc_server")
}
