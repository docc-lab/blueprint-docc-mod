...
func New_TracePressureService_HTTPServerHandler(ctx context.Context, service socialnetwork.TracePressureService, serverAddress string) (*TracePressureService_HTTPServerHandler, error) {
