...
func init() {
	...
	postCacheRegistry.Register("post_cache_v_es", func(ctx context.Context) (backend.Cache, error) {
		// Build the client library
		namespace, err := clientlib.Build(ctx)
		if err != nil {
			return nil, err
	...
	userTimelineCacheRegistry.Register("hometimeline_cache_v_es", func(ctx context.Context) (backend.Cache, error) {
		// Build the client library
		namespace, err := clientlib.Build(ctx)
		if err != nil {
			return nil, err
	...
	userCacheRegistry.Register("hometimeline_cache_v_es", func(ctx context.Context) (backend.Cache, error) {
		// Build the client library
		namespace, err := clientlib.Build(ctx)
		if err != nil {
			return nil, err
	...
	userMentionServiceRegistry.Register("usermention_service_v_es", func(ctx context.Context) (socialnetwork.UserMentionService, error) {
		// Build the client library
		namespace, err := clientlib.Build(ctx)
		if err != nil {
			return nil, err
		...
		err = namespace.Get("usermention_service_v_es.client", &client)
		return client, err
	})
	...
	userDBRegistry.Register("usertimeline_db_v_es", func(ctx context.Context) (backend.NoSQLDatabase, error) {
		// Build the client library
		namespace, err := clientlib.Build(ctx)
		if err != nil {
			return nil, err
	...
	postStorageServiceRegistry.Register("post_storage_service_v_es", func(ctx context.Context) (socialnetwork.PostStorageService, error) {
		// Build the client library
		namespace, err := clientlib.Build(ctx)
		if err != nil {
			return nil, err
		...
		err = namespace.Get("post_storage_service_v_es.client", &client)
		return client, err
	})
