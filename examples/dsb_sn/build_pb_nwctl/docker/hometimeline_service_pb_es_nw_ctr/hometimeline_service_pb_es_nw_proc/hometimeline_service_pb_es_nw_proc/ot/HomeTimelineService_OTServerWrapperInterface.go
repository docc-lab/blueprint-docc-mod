...
func New_HomeTimelineService_OTServerWrapper(ctx context.Context, service snnw.HomeTimelineService, coll_client backend.Tracer) (*HomeTimelineService_OTServerWrapper, error) {
