...
func set_golang_Instances(b *golang.NamespaceBuilder) {
	b.Instantiate("jaeger_pb_rev0.client")
...
func set_golang_Definitions(b *golang.NamespaceBuilder) {
	b.Define("jaeger_pb_rev0.client", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var addr string
		if err := n.Get("jaeger_pb_rev0.otlp.dial_addr", &addr); err != nil {
			return nil, err
		}
