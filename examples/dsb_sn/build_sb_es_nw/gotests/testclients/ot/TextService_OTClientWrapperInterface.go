...
type TextService_OTClientWrapperInterface interface {
	ComposeText(ctx context.Context, reqID int64, text string) (string, []snnw.UserMention, []snnw.URL, error)
...
func (handler *TextService_OTClientWrapper) ComposeText(ctx context.Context, reqID int64, text string) (ret0 string, ret1 []snnw.UserMention, ret2 []snnw.URL, err error) {
