...
func set_golang_Definitions(b *golang.NamespaceBuilder) {
	b.Define("jaeger_sb_es_nw.client", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var addr string
		if err := n.Get("jaeger_sb_es_nw.otlp.dial_addr", &addr); err != nil {
			return nil, err
		}
