...
func New_UserTimelineService_OTServerWrapper(ctx context.Context, service snnw.UserTimelineService, coll_client backend.Tracer) (*UserTimelineService_OTServerWrapper, error) {
