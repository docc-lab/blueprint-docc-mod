...
type ComposePostService_RetrierClient struct {
	Client snnw.ComposePostService
	MaxTries int
}

func New_ComposePostService_RetrierClient (ctx context.Context, client snnw.ComposePostService) (*ComposePostService_RetrierClient, error) {
