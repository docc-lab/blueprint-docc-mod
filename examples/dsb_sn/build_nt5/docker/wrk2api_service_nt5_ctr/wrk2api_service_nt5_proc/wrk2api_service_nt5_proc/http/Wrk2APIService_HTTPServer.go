...
func New_Wrk2APIService_HTTPServerHandler(ctx context.Context, service socialnetwork.Wrk2APIService, serverAddress string) (*Wrk2APIService_HTTPServerHandler, error) {
