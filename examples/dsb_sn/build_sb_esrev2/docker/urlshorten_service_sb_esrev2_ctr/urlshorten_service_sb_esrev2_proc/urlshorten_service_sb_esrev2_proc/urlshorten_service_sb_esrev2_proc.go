...
func New_urlshorten_service_sb_esrev2_proc(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_urlshorten_service_sb_esrev2_proc_Args(b)
	set_urlshorten_service_sb_esrev2_proc_Instances(b)
	set_urlshorten_service_sb_esrev2_proc_Definitions(b)
	return b
}
...
func set_urlshorten_service_sb_esrev2_proc_Args(b *golang.NamespaceBuilder) {
	b.Required("otelcol_sb_esrev2.dial_addr", "Argument generated by Blueprint IR: otelcol_sb_esrev2.dial_addr = AddressConfig()")
	b.Required("urlshorten_db_sb_esrev2.dial_addr", "Argument generated by Blueprint IR: urlshorten_db_sb_esrev2.dial_addr = AddressConfig()")
	b.Required("urlshorten_service_sb_esrev2.grpc.bind_addr", "Argument generated by Blueprint IR: urlshorten_service_sb_esrev2.grpc.bind_addr = AddressConfig()")
}
...
func set_urlshorten_service_sb_esrev2_proc_Instances(b *golang.NamespaceBuilder) {
	...
	b.Instantiate("urlshorten_db_sb_esrev2.client")
	b.Instantiate("urlshorten_service_sb_esrev2")
	b.Instantiate("otelcol_sb_esrev2.client")
	b.Instantiate("urlshorten_service_sb_esrev2.server.ot")
	b.Instantiate("urlshorten_service_sb_esrev2.grpc_server")
}
