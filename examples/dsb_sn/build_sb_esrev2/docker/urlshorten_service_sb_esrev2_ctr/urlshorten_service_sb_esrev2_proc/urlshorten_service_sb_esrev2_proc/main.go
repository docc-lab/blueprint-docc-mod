// urlshorten_service_sb_esrev2_proc runs the urlshorten_service_sb_esrev2_proc Golang process.
//
// urlshorten_service_sb_esrev2_proc is auto-generated by Blueprint's goproc plugin (goproc/goprocgen/main.go.go)
//
// Usage:
//
//	go run main.go --urlshorten_db_sb_esrev2.dial_addr=value --otelcol_sb_esrev2.dial_addr=value --urlshorten_service_sb_esrev2.grpc.bind_addr=value
//
...
//
// urlshorten_service_sb_esrev2_proc requires the following arguments are passed:
//
//	--urlshorten_db_sb_esrev2.dial_addr
//	    Auto-generated by Blueprint IR node:
//	    urlshorten_db_sb_esrev2.dial_addr = AddressConfig()
//
...
//	    Auto-generated by Blueprint IR node:
//	    urlshorten_service_sb_esrev2.grpc.bind_addr = AddressConfig()
//
// urlshorten_service_sb_esrev2_proc will instantiate the following IR nodes:
//
...
func main() {
	...
	slog.Info("Running urlshorten_service_sb_esrev2_proc")
	n, err := New_urlshorten_service_sb_esrev2_proc("urlshorten_service_sb_esrev2_proc").Build(context.Background())
	if err != nil {
		slog.Error(err.Error())
		os.Exit(1)
	}
	n.Await()
	slog.Info("urlshorten_service_sb_esrev2_proc exiting")
}
