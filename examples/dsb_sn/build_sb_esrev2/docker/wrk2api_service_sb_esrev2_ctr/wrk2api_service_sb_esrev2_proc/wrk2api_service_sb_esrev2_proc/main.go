// wrk2api_service_sb_esrev2_proc runs the wrk2api_service_sb_esrev2_proc Golang process.
//
// wrk2api_service_sb_esrev2_proc is auto-generated by Blueprint's goproc plugin (goproc/goprocgen/main.go.go)
//
// Usage:
//
//	go run main.go --user_service_sb_esrev2.grpc.dial_addr=value --otelcol_sb_esrev2.dial_addr=value --composepost_service_sb_esrev2.grpc.dial_addr=value --usertimeline_service_sb_esrev2.grpc.dial_addr=value --hometimeline_service_sb_esrev2.grpc.dial_addr=value --socialgraph_service_sb_esrev2.grpc.dial_addr=value --wrk2api_service_sb_esrev2.http.bind_addr=value
//
...
//
// wrk2api_service_sb_esrev2_proc requires the following arguments are passed:
//
...
//	    Auto-generated by Blueprint IR node:
//	    composepost_service_sb_esrev2.grpc.dial_addr = AddressConfig()
//
...
//	    Auto-generated by Blueprint IR node:
//	    wrk2api_service_sb_esrev2.http.bind_addr = AddressConfig()
//
// wrk2api_service_sb_esrev2_proc will instantiate the following IR nodes:
//
...
func main() {
	...
	slog.Info("Running wrk2api_service_sb_esrev2_proc")
	n, err := New_wrk2api_service_sb_esrev2_proc("wrk2api_service_sb_esrev2_proc").Build(context.Background())
	if err != nil {
		slog.Error(err.Error())
		os.Exit(1)
	}
	n.Await()
	slog.Info("wrk2api_service_sb_esrev2_proc exiting")
}
