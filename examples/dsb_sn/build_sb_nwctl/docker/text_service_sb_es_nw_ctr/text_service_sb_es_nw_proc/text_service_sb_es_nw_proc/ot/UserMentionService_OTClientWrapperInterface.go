...
type UserMentionService_OTClientWrapperInterface interface {
	ComposeUserMentions(ctx context.Context, reqID int64, usernames []string) ([]snnw.UserMention, error)
}
...
func (handler *UserMentionService_OTClientWrapper) ComposeUserMentions(ctx context.Context, reqID int64, usernames []string) (ret0 []snnw.UserMention, err error) {
