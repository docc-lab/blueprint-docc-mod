...
func New_UniqueIdService_OTServerWrapper(ctx context.Context, service snnw.UniqueIdService, coll_client backend.Tracer) (*UniqueIdService_OTServerWrapper, error) {
