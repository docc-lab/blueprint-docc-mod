...
func New_MediaService_OTServerWrapper(ctx context.Context, service socialnetwork.MediaService, coll_client backend.Tracer) (*MediaService_OTServerWrapper, error) {
...
func (handler *MediaService_OTServerWrapper) ComposeMedia(ctx context.Context, reqID int64, mediaTypes []string, mediaIds []int64, traceCtx string) (ret0 []socialnetwork.Media, err error) {
