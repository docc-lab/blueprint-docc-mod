...
//
// It provides funcs for instantiating the fancy_greeter_proc namespace.
//
// To instantiate the fancy_greeter_proc namespace, first call [New_fancy_greeter_proc] and then either call 
...
import (
	...
	"blueprint/goproc/fancy_greeter_proc/retries"
	"github.com/blueprint-uservices/blueprint/runtime/plugins/fancygreeter"
	"github.com/blueprint-uservices/blueprint/runtime/core/backend"
	"blueprint/goproc/fancy_greeter_proc/http"
	...
	"blueprint/goproc/fancy_greeter_proc/pool"
	"blueprint/goproc/fancy_greeter_proc/ot"
	"github.com/blueprint-uservices/blueprint/runtime/plugins/zipkin"
)

// Initializes the fancy_greeter_proc namespace by defining all of the nodes that run
...
func New_fancy_greeter_proc(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_fancy_greeter_proc_Args(b)
	set_fancy_greeter_proc_Instances(b)
	set_fancy_greeter_proc_Definitions(b)
	return b
}

// fancy_greeter_proc requires that its arguments are either:
...
func set_fancy_greeter_proc_Args(b *golang.NamespaceBuilder) {
	b.Required("basic_greeter.grpc.dial_addr", "Argument generated by Blueprint IR: basic_greeter.grpc.dial_addr = AddressConfig()")
	b.Required("fancy_greeter.http.bind_addr", "Argument generated by Blueprint IR: fancy_greeter.http.bind_addr = AddressConfig()")
	b.Required("zipkin.dial_addr", "Argument generated by Blueprint IR: zipkin.dial_addr = AddressConfig()")
}

// When the fancy_greeter_proc namespace is built it will automatically instantiate
// the following nodes:
...
func set_fancy_greeter_proc_Instances(b *golang.NamespaceBuilder) {
	b.Instantiate("fancy_greeter_proc.stdoutmetriccollector")
	b.Instantiate("fancy_greeter_proc.logger")
	b.Instantiate("basic_greeter.clientpool")
	b.Instantiate("basic_greeter.client.retrier")
	b.Instantiate("fancy_greeter")
	b.Instantiate("zipkin.client")
	b.Instantiate("fancy_greeter.server.ot")
	b.Instantiate("fancy_greeter.http_server")
}

// The fancy_greeter_proc namespace contains definitions for instantiating
// the following nodes:
//   basic_greeter.client.retrier
//   basic_greeter.clientpool
//   fancy_greeter
...
//   fancy_greeter_proc.stdoutmetriccollector
//   zipkin.client
func set_fancy_greeter_proc_Definitions(b *golang.NamespaceBuilder) {
	...
	b.Define("fancy_greeter", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
	...
	b.Define("fancy_greeter.http_server", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var service ot.FancyGreeterService_OTServerWrapperInterface
		if err := n.Get("fancy_greeter.server.ot", &service); err != nil {
			return nil, err
		}
		
		var serverAddr string
		if err := n.Get("fancy_greeter.http.bind_addr", &serverAddr); err != nil {
			return nil, err
		}
	...
	b.Define("fancy_greeter.server.ot", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var service fancygreeter.FancyGreeterService
		if err := n.Get("fancy_greeter", &service); err != nil {
			return nil, err
		}
	...
	b.Define("fancy_greeter_proc.logger", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		return slogger.NewSLogger(n.Context())
	})
	
	b.Define("fancy_greeter_proc.stdoutmetriccollector", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
