...
func set_golang_Instances(b *golang.NamespaceBuilder) {
	b.Instantiate("fancy_greeter_1.clientpool")
	b.Instantiate("fancy_greeter_1.client.retrier")
	b.Instantiate("fancy_greeter_0.clientpool")
	b.Instantiate("fancy_greeter_0.client.retrier")
...
func set_golang_Definitions(b *golang.NamespaceBuilder) {
	...
	b.Define("fancy_greeter_0.client.retrier", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var client ot.FancierGreeterService_OTClientWrapperInterface
		if err := n.Get("fancy_greeter_0.clientpool", &client); err != nil {
			return nil, err
		}
	...
	b.Define("fancy_greeter_0.clientpool", func(n *golang.Namespace) (any, error) {
		return pool.New_FancierGreeterService_Pool(n), nil
	})
	
	b.Define("fancy_greeter_1.client.retrier", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var client ot.FancierGreeterService_OTClientWrapperInterface
		if err := n.Get("fancy_greeter_1.clientpool", &client); err != nil {
			return nil, err
		}
	...
	b.Define("fancy_greeter_1.clientpool", func(n *golang.Namespace) (any, error) {
		return pool.New_FancierGreeterService_Pool(n), nil
	})
