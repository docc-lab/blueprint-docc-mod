...
catalogue_proc() {
	...
	run_catalogue_proc() {
        ...
        cd catalogue_proc
        ./catalogue_proc --catalogue_db.dial_addr=$CATALOGUE_DB_DIAL_ADDR --otelcol.dial_addr=$OTELCOL_DIAL_ADDR --catalogue_service.grpc.bind_addr=$CATALOGUE_SERVICE_GRPC_BIND_ADDR &
        CATALOGUE_PROC=$!
        return $?
