...
type CatalogueService_RetrierClient struct {
	Client catalogue.CatalogueService
	MaxTries int
}

func New_CatalogueService_RetrierClient (ctx context.Context, client catalogue.CatalogueService) (*CatalogueService_RetrierClient, error) {
