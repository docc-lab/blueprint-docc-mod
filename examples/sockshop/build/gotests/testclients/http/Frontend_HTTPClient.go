...
func (client *Frontend_HTTPClient) AddItem(ctx context.Context, sessionID string, itemID string) (ret0 string, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) DeleteCart(ctx context.Context, sessionID string) (err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetAddress(ctx context.Context, addressID string) (ret0 user.Address, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetCard(ctx context.Context, cardID string) (ret0 user.Card, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetCart(ctx context.Context, sessionID string) (ret0 []cart.Item, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetOrder(ctx context.Context, orderID string) (ret0 order.Order, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetOrders(ctx context.Context, userID string) (ret0 []order.Order, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetSock(ctx context.Context, itemID string) (ret0 catalogue.Sock, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) GetUser(ctx context.Context, userID string) (ret0 user.User, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) ListItems(ctx context.Context, tags []string, order string, pageNum int, pageSize int) (ret0 []catalogue.Sock, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) ListTags(ctx context.Context) (ret0 []string, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) LoadCatalogue(ctx context.Context) (ret0 string, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) Login(ctx context.Context, sessionID string, username string, password string) (ret0 string, ret1 user.User, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) NewOrder(ctx context.Context, userID string, addressID string, cardID string, cartID string) (ret0 order.Order, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) PostAddress(ctx context.Context, userID string, address user.Address) (ret0 string, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) PostCard(ctx context.Context, userID string, card user.Card) (ret0 string, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) Register(ctx context.Context, sessionID string, username string, password string, email string, first string, last string) (ret0 string, err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) RemoveItem(ctx context.Context, sessionID string, itemID string) (err error) {
	vals := url.Values{}
...
func (client *Frontend_HTTPClient) UpdateItem(ctx context.Context, sessionID string, itemID string, quantity int) (ret0 string, err error) {
	vals := url.Values{}
