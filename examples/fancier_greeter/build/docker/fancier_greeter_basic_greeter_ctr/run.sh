...
fancier_greeter_basic_greeter_proc() {
	...
	run_fancier_greeter_basic_greeter_proc() {
        ...
        ./fancier_greeter_basic_greeter_proc --tracing_agent.dial_addr=$TRACING_AGENT_DIAL_ADDR --fancier_greeter__basic_greeter.grpc.bind_addr=$FANCIER_GREETER_BASIC_GREETER_GRPC_BIND_ADDR &
        FANCIER_GREETER_BASIC_GREETER_PROC=$!
        return $?
