...
fancier_greeter_proc() {
	...
	run_fancier_greeter_proc() {
        ...
        ./fancier_greeter_proc --fancier_greeter__basic_greeter.grpc.dial_addr=$FANCIER_GREETER_BASIC_GREETER_GRPC_DIAL_ADDR --zipkin.dial_addr=$ZIPKIN_DIAL_ADDR --fancier_greeter.http.bind_addr=$FANCIER_GREETER_HTTP_BIND_ADDR &
        FANCIER_GREETER_PROC=$!
        return $?
