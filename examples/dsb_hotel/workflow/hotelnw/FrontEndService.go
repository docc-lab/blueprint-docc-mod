...
// Tomislav-RetCtx: the front end is already pure orchestration (argument checks + downstream calls),
// so it is the hotelreservation front end unchanged; only its downstream services are zero-work.
