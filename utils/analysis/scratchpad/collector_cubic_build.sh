...
# plus the one-line configdiscovery change that accepts reverse_policy depth_cubic. Pushed under a
...
TAG=10.10.1.1:30000/otelcontribcol:cubic-20260923
...
echo "$DIGEST" > $S/collector_cubic_digest
