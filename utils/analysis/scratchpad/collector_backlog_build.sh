...
# plus the depth_cubic configdiscovery change AND the priority processor us_margin_mode=backlog + lp_refusal_code options (defaults unchanged). Pushed under a
...
TAG=10.10.1.1:30000/otelcontribcol:prio-backlog-20260923
...
echo "$DIGEST" > $S/collector_backlog_digest
