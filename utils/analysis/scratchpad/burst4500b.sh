#!/usr/bin/env bash
# Tomislav-RetCtx: RERUN of the bursty runs with a 5000-trace uniformly drawn sample per point (was 100 most-recent). BURSTY stationary runs on the ClickHouse backend with the gateway capped at 2 CPU
