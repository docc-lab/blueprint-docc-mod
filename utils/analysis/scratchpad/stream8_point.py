...
app = 'HOTELNW' if 'retctx-hotelnw' in f else ('HOTEL' if '/dsb-hotel/' in f else 'SN')
...
if app == 'SN':
    ...
    nt_roots = [root('hotelnw_nt_root')]; v_root = root('hotelnw_v_root'); prev = []; plabel = ''
    rw = {'nt': 'retctx-hotel-mem-nt-20260924T045738Z', 'v': 'retctx-hotel-mem-v-20260924T051302Z'}.get(kind, 'retctx-hotel-mem-br-20260924T051305Z')
    prev = [f'/users/tomislav/deployments/dsb-hotel/{rw}/run/01-{kind}/rate-{rate:05d}/result.json']; plabel = 'real-work'
else:
