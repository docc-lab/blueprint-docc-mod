...
def main():
    ...
    while True:
        ...
        progress = {'updated': now(), 'runner': status, 'completed_points': len(rows), 'total_points': 320,
                    'completed_runs': len(complete_runs), 'total_runs': 20,
        ...
        lines = ['# Tomislav-RetCtx: active end-to-end ramp', '',
                 ...
                 f"State: {status['state']}; {len(rows)}/320 points, {len(complete_runs)}/20 ramps complete.",
