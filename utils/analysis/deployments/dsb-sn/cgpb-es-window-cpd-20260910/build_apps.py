...
BUILD = REPO / 'examples/dsb_sn/build_cgpb_es_window_20260910'
...
for deployment in APPS:
    ...
    for filename in ['checkpoint_distance.go', 'checkpoint_window.go', 'cgpb_processor.go', 'pb_processor.go', 'sb_processor.go']:
