...
//
// To instantiate a Jaeger container with a trace coordinator:
//
//	collector := jaeger.Collector(spec, "jaeger", "coordinator")
//
...
//
//	jaeger.Collector(spec, "jaeger", "coordinator")
func Collector(spec wiring.WiringSpec, collectorName string, coordinatorName ...string) string {
	...
	spec.Define(collectorClient, &JaegerCollectorClient{}, func(ns wiring.Namespace) (ir.IRNode, error) {
		...
		return newJaegerCollectorClient(collectorClient, addr.Dial, coordinator)
	})
